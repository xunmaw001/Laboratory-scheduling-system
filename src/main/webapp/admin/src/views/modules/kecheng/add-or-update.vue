               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学期" prop="xueqiTypes">
                        <el-select v-model="ruleForm.xueqiTypes" :disabled="ro.xueqiTypes" placeholder="请选择学期">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="星期" prop="xingqiTypes">
                        <el-select v-model="ruleForm.xingqiTypes" :disabled="ro.xingqiTypes" placeholder="请选择星期">
                            <el-option
                                v-for="(item,index) in xingqiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="星期" prop="xingqiValue">
                        <el-input v-model="ruleForm.xingqiValue"
                            placeholder="星期" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="第几节" prop="jiekeTypes">
                        <el-select v-model="ruleForm.jiekeTypes" :disabled="ro.jiekeTypes" placeholder="请选择第几节">
                            <el-option
                                v-for="(item,index) in jiekeTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="第几节" prop="jiekeValue">
                        <el-input v-model="ruleForm.jiekeValue"
                            placeholder="第几节" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                jiaoshiForm: {},
                shiyanshishenqingForm: {},
                ro:{
                    shiyanshishenqingId: false,
                    kechengName: false,
                    kechengPhoto: false,
                    shangkeTime: false,
                    xiakeTime: false,
                    ...
                    jiekeTypes: false,
                    jiaoshiId: false,
                    kechengYesnoTypes: false,
                    kechengYesnoText: false,
                ...
                xingqiTypesOptions : [],
                jiekeTypesOptions : [],
                kechengYesnoTypesOptions : [],
                jiaoshiOptions : [],
                shiyanshishenqingOptions : [],
                rules: {
                   shiyanshishenqingId: [
                   ...
                   kechengYesnoTypes: [
                              { required: true, message: '课程审核不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xingqi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xingqiTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jieke_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiekeTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=kecheng_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.kechengYesnoTypesOptions = data.data.list;
                    }
                });
         ...
         this.$http({
             url: `shiyanshishenqing/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.shiyanshishenqingOptions = data.data.list;
            }
         });
		 if(this.$route.query.shiyanshishenqingId){
			 this.ruleForm.shiyanshishenqingId = this.$route.query.shiyanshishenqingId
		 }
        ...
        methods: {
            ...
            shiyanshishenqingChange(id){
                this.$http({
                    url: `shiyanshishenqing/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiyanshishenqingForm = data.data;
                    }
                });
            },
            // 多级联动参数
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.shiyanshishenqingChange(data.data.shiyanshishenqingId)
                    } else {
