...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shiyanshiId: false,
                    jiaoshiId: false,
                    shiyanshishenqingYesnoTypes: false,
                    shiyanshishenqingYesnoText: false,
                },
                ruleForm: {
                    shiyanshiId: '',
                    jiaoshiId: '',
                    shiyanshishenqingYesnoTypes: '',
                    shiyanshishenqingYesnoText: '',
                },
                shiyanshishenqingYesnoTypesOptions : [],
                jiaoshiOptions : [],
                shiyanshiOptions : [],
                rules: {
                   shiyanshiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiyanshishenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiyanshishenqingYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shiyanshishenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shiyanshishenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
